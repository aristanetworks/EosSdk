...
#ifndef EOS_TYPES_BGP_PATH_IMPL_H
#define EOS_TYPES_BGP_PATH_IMPL_H
...
class EOS_SDK_PUBLIC bgp_path_attr_fields_impl_t {
 public:
   bgp_path_attr_fields_impl_t();
   /** Create BGP path attribute field options. */
   explicit bgp_path_attr_fields_impl_t(bool next_hop);
   ...
   friend std::ostream& operator<<(std::ostream& os,
                                   const bgp_path_attr_fields_impl_t& obj);
...
class EOS_SDK_PUBLIC bgp_path_options_impl_t {
 public:
   bgp_path_options_impl_t();
   /** Create BGP path options. */
   explicit bgp_path_options_impl_t(bgp_receive_route_stage_t receive_route_stage);
    ...
    */
   friend std::ostream& operator<<(std::ostream& os,
                                   const bgp_path_options_impl_t& obj);
...
class EOS_SDK_PUBLIC bgp_path_attr_impl_t {
 public:
   bgp_path_attr_impl_t();
   explicit bgp_path_attr_impl_t(uint8_t origin, uint32_t med, uint32_t local_pref);
    ...
    */
   friend std::ostream& operator<<(std::ostream& os,
                                   const bgp_path_attr_impl_t& obj);
...
class EOS_SDK_PUBLIC bgp_path_key_impl_t {
 public:
   bgp_path_key_impl_t();
   /** Create BGP path key. */
   explicit bgp_path_key_impl_t(ip_prefix_t const & prefix,
...
/** The BGP path entry. */
class EOS_SDK_PUBLIC bgp_path_impl_t {
 public:
   bgp_path_impl_t();
   explicit bgp_path_impl_t(bgp_path_key_t const & path_key);
    ...
    * the ostream.
    */
   friend std::ostream& operator<<(std::ostream& os, const bgp_path_impl_t& obj);
...
#endif // EOS_TYPES_BGP_PATH_IMPL_H
