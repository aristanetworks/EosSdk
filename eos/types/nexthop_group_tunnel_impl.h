...
#ifndef EOS_TYPES_NEXTHOP_GROUP_TUNNEL_IMPL_H
#define EOS_TYPES_NEXTHOP_GROUP_TUNNEL_IMPL_H
 ...
 */
class EOS_SDK_PUBLIC nexthop_group_tunnel_impl_t {
 public:
   /** Default constructor. */
    ...
    */
   explicit nexthop_group_tunnel_impl_t(ip_prefix_t const & tunnel_endpoint,
   ...
   friend std::ostream& operator<<(std::ostream& os,
                                   const nexthop_group_tunnel_impl_t& obj);
...
#endif // EOS_TYPES_NEXTHOP_GROUP_TUNNEL_IMPL_H
